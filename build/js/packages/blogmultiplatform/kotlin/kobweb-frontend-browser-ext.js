(function (root, factory) {
  ...
  var decapitalize = kotlin_kotlin.$_$.c7;
  ...
  function Companion() {
    ...
    this.os_1 = new CancellableActionHandle(0);
  }
  ...
  function CancellableActionHandle(id, isInterval) {
    ...
    this.ps_1 = isInterval;
    this.qs_1 = id;
  }
  protoOf(CancellableActionHandle).rs = function () {
    if (this.ps_1) {
      self.clearInterval(this.qs_1);
    } else {
      self.clearTimeout(this.qs_1);
    }
    this.qs_1 = 0;
  };
  function setInterval(_this__u8e3s4, delay, block) {
    var id = _this__u8e3s4.setInterval(block, _Duration___get_inWholeMilliseconds__impl__msfiry(delay).nb());
  ...
  function setTimeout(_this__u8e3s4, timeout, block) {
    var id = _this__u8e3s4.setTimeout(block, _Duration___get_inWholeMilliseconds__impl__msfiry(timeout).nb());
