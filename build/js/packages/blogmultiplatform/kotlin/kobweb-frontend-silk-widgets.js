(function (root, factory) {
  ...
  var Companion_getInstance_14 = kotlin_com_varabyte_kobweb_silk_foundation.$_$.o1;
  ...
  var get_SilkTheme = kotlin_com_varabyte_kobweb_silk_foundation.$_$.i1;
  ...
  function ButtonStyle$lambda$lambda() {
    ...
    return transition(userSelect(border(tmp, ButtonStyle$lambda$lambda$lambda), Companion_getInstance_3().get_None_wo6tgh_k$()), [CSSTransition_init_$Create$('background-color', ButtonVars_getInstance().get_ColorTransitionDuration_d6ufct_k$().value$default_36t2hw_k$())]);
  }
  ...
  function setSilkWidgetVariables(_this__u8e3s4, colorMode) {
    ...
    var silkColorsStyleName = get_SilkTheme().nameFor_31dp2a_k$(get_SilkColorsStyle());
  ...
  function setSilkWidgetVariables_0(_this__u8e3s4, $composer, $changed) {
    ...
    $composer_0.startReplaceableGroup_ip860b_k$(263028585);
    // Inline function 'androidx.compose.runtime.cache' call
    var this_0 = $composer_0;
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
  ...
  function SmoothColorStyle$lambda($this$base) {
    _init_properties_CommonStyles_kt__a7wisz_0();
    return transition(Companion_getInstance(), [CSSTransition_init_$Create$('background-color', get_SmoothColorTransitionDurationVar_0().value$default_36t2hw_k$())]);
  }
